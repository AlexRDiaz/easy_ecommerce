...
class _DashBoardLogisticState extends State<DashBoardLogistic> {
  TextEditingController sellerController = TextEditingController(text: "TODO");
                          ...
                          child: ExpansionTile(
                            ...
                            children: [
                              Row(
                                children: [
                                  Container(
                                      width: 100, child: Text("Vendedores: ")),
                                  _sellers(context)
                                ],
                              ),
                              Row(
                              ...
                              Row(
                                children: [
                                  Container(
                                      width: 100, child: Text("Operadores: ")),
                                  _operators(context)
                                ],
                              ),
                              //  _sellers(context),
              ...
              onPressed: () async {
                ...
                setState(() {
                  if (results != null) {
                    ...
                    sharedPrefs!.setString("dateDesdeLogistic", nuevaFecha);
                  }
                });
              },
              child: Text(
                "${sharedPrefs!.getString("dateDesdeLogistic")}",
              ...
              onPressed: () async {
                ...
                setState(() {
                  if (results != null) {
                    ...
                    sharedPrefs!.setString("dateHastaLogistic", nuevaFecha);
                  }
                });
              },
              child: Text(
                "${sharedPrefs!.getString("dateHastaLogistic")}",
                style: TextStyle(fontWeight: FontWeight.bold),
              )),
          SizedBox(
            width: 10,
